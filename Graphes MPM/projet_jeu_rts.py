...
if __name__ == "__main__":
    ...
    Construction_batiment = Tache("Construction de batiment par les batiments", 3, Icone_creation_batiment, Icone_batiment, HUD_batiment)
    ...
    # Jeu.
    Victoire_defaite = Tache("Création d'une victoire et d'une défaite pour les joueurs durant la partie", 2, Destruction_batiment)
    ...
    Equilibrage = Tache("Equilibrer les différentes variables des créations d'unités", 8, Victoire_defaite)
    Equipe_predetermine = Tache("Création d'une équipe prédeterminé", 3, Generation_unite, Icones_unite, Modeliser_autre_unite, Equilibrage)
    ...
    Calcul_niveau_joueur = Tache("Chercher à calculer le niveau des joueurs pour améliorer le matchmaking", 2, Victoire_defaite)
    Matchmaking = Tache("Générer des matches automatiquement", 3, Victoire_defaite, Jeu_reseau)
    Retour_joueur = Tache("Pouvoir obtenir le retour des joueurs apres une partie", 2, Victoire_defaite)

    # Deployement.
    Plateforme = Tache("Observer si le jeu fonctionne sur les différentes plateforme concernées", 5, Matchmaking, Retour_joueur, Calcul_niveau_joueur)
    ...
    Publicite = Tache("Envoyer des publicités pour inviter les joueurs à tester le jeu", 6, Forum)
