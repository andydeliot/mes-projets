...
class Personnage:
    ...
    def appliquer_sort(self, sort):
        ...
        for etat in self.etats:
            etat.activation_cible_sort(copie_sort)
...
class Etat:
    ...
    # Activations.
    def activation_cible_sort(self, sort):
        """ Utilise l'état lorsque le joueur est touché par un sort. """
        pass

    def activation_directe(self):
        """ Utilise l'état immédiatement. """
        pass

    # Désactivations.
    def desactivation_directe(self):
        """ Desactive l'état immédiatement. """
        pass
...
class Precision(Etat):
    ...
    def activation_directe(self):
        for sort in self.personnage.sorts:
            for _ in range(self.portee):
                sort.conditions.append(precision)

    def desactivation_directe(self):
        for sort in self.personnage.sorts:
            for condition in list(sort.conditions):
                if condition is precision:
                    sort.conditions.remove(condition)
